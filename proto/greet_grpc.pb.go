...
const (
	GreetService_SayHello_FullMethodName                       = "/grpc.GreetService/SayHello"
	GreetService_SayHelloServerStreaming_FullMethodName        = "/grpc.GreetService/SayHelloServerStreaming"
	GreetService_SayHelloClentStreaming_FullMethodName         = "/grpc.GreetService/SayHelloClentStreaming"
	GreetService_SayHelloBidirectionalStreaming_FullMethodName = "/grpc.GreetService/SayHelloBidirectionalStreaming"
)
...
type GreetServiceClient interface {
	...
	SayHelloClentStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MessageList], error)
...
func (c *greetServiceClient) SayHelloClentStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MessageList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], GreetService_SayHelloClentStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClentStreamingClient = grpc.ClientStreamingClient[HelloRequest, MessageList]
...
type GreetServiceServer interface {
	...
	SayHelloClentStreaming(grpc.ClientStreamingServer[HelloRequest, MessageList]) error
...
func (UnimplementedGreetServiceServer) SayHelloClentStreaming(grpc.ClientStreamingServer[HelloRequest, MessageList]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloClentStreaming not implemented")
}
...
func _GreetService_SayHelloClentStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloClentStreaming(&grpc.GenericServerStream[HelloRequest, MessageList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClentStreamingServer = grpc.ClientStreamingServer[HelloRequest, MessageList]
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloClentStreaming",
			Handler:       _GreetService_SayHelloClentStreaming_Handler,
			ClientStreams: true,
		},
		{
